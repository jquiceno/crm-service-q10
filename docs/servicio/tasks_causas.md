...
| T7 | **Juan Camilo** | Get loss reason by id use case | `F3.2`, `F3.7` | `feat/loss-reasons-get-by-id` | `feat/loss-reasons` | 2 | T4 | F2 | ✅ **ejecutada** — `F3.2` y `F3.7` `done` y verificados; pendiente de PR a la base |
