...
**El backlog está en ejecución. Cinco tareas dentro de la base** —T2, T3, T4 (PR #5), T6 (PR #19) y T8 (PR #20)— **con la base verde**. La base recibió además un **merge de `main`** (`f3a8590`), que trae la plantilla al día.
