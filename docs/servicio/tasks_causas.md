...
| T8 | **Brayan** | Create loss reason use case | `F3.3`, `F3.8` | `feat/loss-reasons-create` | `feat/loss-reasons` | 3 | T4 | F3 | ✅ **mergeada** a la base — PR #20, merge `56f1eaa` |
...
- **Ola 3:** solo queda **T5** (Juan Camilo, `feat/loss-reasons-usage-reader`), con PR abierto y dos rondas de revisión aplicadas. No bloquea a nadie salvo a **T10**.
- **Ola 4:** T6 y T8 ya están dentro. **T7** (Juan Camilo) está **aprobada y pendiente de merge**; **T9** (Brayan) está terminada y verificada en su rama, pendiente de PR; y **T10** espera además a T5.
