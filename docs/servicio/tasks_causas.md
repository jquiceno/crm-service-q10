...
| T7 | **Juan Camilo** | Get loss reason by id use case | `F3.2`, `F3.7` | `feat/loss-reasons-get-by-id` | `feat/loss-reasons` | 2 | T4 | F2 | ✅ **ejecutada y aprobada** — `F3.2` y `F3.7` `done` y verificados; PR aprobado, pendiente de merge |
...
**El backlog está en ejecución. Cinco tareas dentro de la base** —T2, T3, T4 (PR #5), T6 (PR #19) y T8 (PR #20)— **con la base verde**.
...
- **Ola 4:** T6 y T8 ya están dentro. **T7** (Juan Camilo) está **aprobada y pendiente de merge**; **T9** (Brayan) está **en revisión de PR** (#28), con T8 ya mezclada en su rama; y **T10** espera además a T5.
