...
- **Ola 4, ya abierta** porque T4 entró: **T8** (Brayan) ya está **dentro de la base** (PR #20) y **T9** (Brayan) está **en revisión de PR** (#28), con T8 ya mezclada en su rama; T6 también está dentro. Queda **T7** (Juan Camilo), que puede arrancar hoy, y **T10**, que espera además a T5.
