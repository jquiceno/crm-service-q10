...
| T9 | **Brayan** | Update loss reason use case | `F3.4`, `F3.9` | `feat/loss-reasons-update` | `feat/loss-reasons` | 3 | T4 | F4 | 🔄 **en curso** — `F3.4` y `F3.9` `done` y verificados (build en verde, 4 tests nuevos, 385 en la suite); **pendiente de merge** a la base |
