    ...
    IDeleteLossReasonUseCase deleteLossReasonUseCase) : ControllerBase
{
    ...
    [EndpointDescription("Deletes the loss reason with the given id. The delete is idempotent: an id that is not there also answers 204. A reason already assigned to a deal answers 409 and is not deleted.")]
